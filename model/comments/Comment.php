...
class Comment extends Model {
    ...
    function getComment($id){
        $result = array();
        $query = "SELECT c.id as commentId,c.comment as comment, u.username as username,u.id as userId FROM comment AS c INNER JOIN user AS u ON c.user_id = u.id where c.id = $id;";
        $rows = $this->db->query($query);
