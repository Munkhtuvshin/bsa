            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Хийх зүйлсийн жагсаалтын төрөл нэмэх</span>
                                <form <?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> class="floating-labels m-t-40" method="POST">
                                    <div class="form-group m-b-40">
                                        <?php
                                        foreach ($getCategories as $getCategory){
                                        ?>
                                        <input type="text" name="todoCatName" class="form-control" id="input1" value="<?php echo $getCategory->name; ?>">
                                        <?php
                                        }
                                        ?>
                                        <span class="bar"></span>
                                        <label for="input1">Төрлийн нэр</label>
                                    </div>
