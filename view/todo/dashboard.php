            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="card-body inbox-panel">
                                <ul class="list-group list-group-full">
                                    <li class="list-group-item ">
                                        <a href="/todo/todo"><i class="icon-speedometer"></i> Хянах самбар </a>
                                    </li>
                                    <li class="list-group-item active">
                                        <a href="/todo/todo/get-list"><i class="icon-note"></i> Хийх ажил </a><span class="label label-rouded label-warning pull-right">
                                        <?php
                                    ...
                                    <li class="list-group-item">
                                        <a href="/todo/todo-task/done-tasks"> <i class="icon-check"></i>  Хийсэн ажил </a><span class="label label-rouded label-themecolor pull-right">
                                            <?php
                                    ...
                                    <li class="list-group-item">
                                        <a href="/todo/todo-task/important-task"> <i class="icon-star"></i> Чухал ажил </a>
                                    </li>
                                </ul>
                                ...
                                <!-- <div class="list-group b-0 mail-list">  
                                    ...
                                    foreach ($categories as $category){
                                    ?>
                                    <a href="#" class="list-group-item"><span class="fa fa-circle text-info m-r-10"></span><?php echo $category->name ?></a>
                                    <?php
                                    }
                                    ?>
                                    <a href="/todo/todoCategory/addCategory" id="addTask" class="list-group-item action action_add_item">+ Төрөл Нэмэх</a>
                                </div>  -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 ">
                                            <h2 class="m-b-0"><i class="icon-list text-info"></i></h2>
                                            <h3 class="">
                                                <?php
                                                foreach ($totalTodos as $totalTodo){
                                                ?>
                                                <?php echo $totalTodo->totalTodo ?>
                                                <?php
                                                }
                                                ?>
                                            </h3>
                                            <h6 class="card-subtitle">Нийт ажлын жагсаалт</h6></div>
                                            <div class="col-12">
                                                <div class="progress">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                        <h2 class="m-b-0"><i class="icon-note text-success"></i></h2>
                                        <h3 class="">
                                            <?php
                                            foreach ($totalTasks as $totalTask){
                                            ?>
                                        ...
                                        <h6 class="card-subtitle">Нийт хийх ажил</h6></div>
                                        <div class="col-12">
                                            <div class="progress">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                        <h2 class="m-b-0"><i class="icon-tag text-purple"></i></h2>
                                        <h3 class="">
                                            <?php
                                            foreach ($totalCategories as $totalCategory){
                                            ?>
                                            <?php echo $totalCategory->totalCategory ?>
                                            <?php
                                            }
                                            ?>
                                        </h3>
                                        <h6 class="card-subtitle">Нийт ажлын ангилал</h6></div>
                                        <div class="col-12">
                                            <div class="progress">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                <h2 class="m-b-0"><i class="icon-check text-warning"></i></h2>
                                                <h3 class="">
                                                    <?php
                                                    foreach ($totalDoneTodos as $totalDoneTodo){
                                                    ?>
                                                ...
                                                <h6 class="card-subtitle">Дуусгасан ажлууд</h6></div>
                                                <div class="col-12">
                                                    <div class="progress">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Хийх ажлын жагсаалт</span>
                                <a href="/todo/todo/addTodo">
                                    <button class="pull-right btn btn-sm btn-rounded btn-info">
                                        <i class="fa fa-plus"></i>
                                        <span>Жагсаалт нэмэх</span>
                                    </button>
                                </a>
                                <!-- /.responsive table -->
                                <div class="table-responsive table-hover">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="/todo/todo/getTodoList/<?php echo $todo->id ?>"><?php echo $todo->todoName ?></a></td>
                                                <td><span class="label label-info">
                                                    <?php echo $todo->catName ?>
                                                </span></td>
                                                <td>
                                                    <a href="/todo/todo/edit/<?php echo $todo->id ?>" data-toggle="tooltip" data-original-title="Засварлах"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a> 
                                                    <a href="/todo/todo/remove/<?php echo $todo->id ?>" data-toggle="tooltip" data-original-title="Устгах"> <i class="fa fa-close text-danger"></i> </a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
                                ...
                                <!-- /. end responsive table -->
                                <div id="deleteModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h4 style="color: red">Устгахдаа итгэлтэй байна уу?</h4>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Болих</button>
                                                <a href="/todo/todo/remove/<?php echo $todo->id ?>" class="btn btn-danger waves-effect" data-dismiss="modal">Тийм, Устгах</a>
                                            </div>
                                        </div>
                                        <!-- /.modal-content
                                    </div>
