                        ...
                        <div class="card">
                            <div class="card-body inbox-panel">
                                <ul class="list-group list-group-full">
                                    ...
                                    <li class="list-group-item">
                                        <a href="/todo/todoTask/importantTask"> <i class="icon-star"></i> Чухал ажил </a><span class="label label-rouded label-danger pull-right">2</span>
                                    </li>
                            ...
                            <div class="card-body">
                                ...
                                <form class="floating-labels m-t-40" method="POST">
                                    <div class="form-group m-b-40">
                                        ...
                                        ?>
                                        <input type="text" name="taskName" class="form-control" id="input1" value="<?php echo $task->taskName; ?>">
                                        <?php
                                        }
                                        ?>
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="todoList" id="input6"">
                                            ...
                                            ?>
                                            <option value="<?php echo $todo->id ?>"<?php if($task->tId == $todo->id){echo "selected";} ?>><?php echo $todo->todoName ?></option>';
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="priority">
                                            <option value=""></option>
                                            <option value="1"<?php if($task->priority == "1"){echo "selected";} ?>>Энгийн</option>
                                            <option value="2"<?php if($task->priority == "2"){echo "selected";} ?>>Чухал</option>
                                            <option value="3"<?php if($task->priority == "3"){echo "selected";} ?>>Маш чухал</option>
                                        </select>
                                    </div>
                                    <div class="form-group m-b-40">
                                        <input type="text" name="startDate" class="form-control" id="input1" value="<?php echo $task->start_date; ?>">
                                        <span class="bar"></span>
                                        <label for="input1">Эхлэх хугацаа</label>
                                    </div>
                                    <div class="form-group m-b-40">
                                        <input type="text" name="endDate" class="form-control" id="input1" value="<?php echo $task->end_date; ?>">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="assignUser" id="input6"">
                                            ...
                                            ?>
                                            <option value="<?php echo $user->id ?>"<?php if($task->uId == $user->id){echo "selected";} ?>><?php echo $user->username ?></option>';
                                            <?php
                                            }
                                            ?>
                                        </select><span class="bar"></span>
