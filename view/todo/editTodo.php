            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Хийх зүйлсийн жагсаалт нэмэх</span>
                                <form class="floating-labels m-t-40" method="POST">
                                    <div class="form-group m-b-40">
                                        <?php
                                        foreach ($todos as $todo){
                                        ?>
                                        <input type="text" name="todoName" class="form-control" id="input1" value="<?php echo $todo->todoName; ?>">
                                        <?php
                                        }
                                        ?>
                                        <span class="bar"></span>
                                        <label for="input1">Хийх ажлын жагсаалтын нэр</label>
                                    </div>
                                    <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="catName" id="input6"">
                                            <option></option>
                                            <?php
                                            foreach ($categories as $category){
                                            ?>
                                            <option value="<?php echo $category->id; ?>"<?php if($todo->catId == $category->id){echo "selected";} ?>><?php echo $category->name; ?></option>';
                                            <?php
                                            }
                                            ?>
