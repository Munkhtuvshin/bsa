                                ...
                                <div class="table-responsive table-hover">
                                    <table class="tblData table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="filled-in chk-col-light-blue" id="sa-params" name="checkBoxTodo">
                                                    <label for="todoCheck"></label>
                                                </td>
                                                <td><span id="taskId"><?php echo $todo->id ?></span></td>
                                                <td><span id="taskName"><?php echo $todo->taskName ?></span></td>
                                                <td><?php echo $todo->start_date ?></td>
                                                <td><?php echo $todo->end_date ?></td>
                                                <td><span class="label label-info"><?php echo $todo->todoName ?></span></td>
                                                <td><?php echo $todo->userName ?></td>
                                                <td><?php echo $todo->createdUserName ?></td>
                                                <td>
