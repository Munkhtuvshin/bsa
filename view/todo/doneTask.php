            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Хийсэн ажлын жагсаалт</span>
                                ...
                                <div class="table-responsive table-hover">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr class="group">
                                                <td colspan="7"><?php echo $todo->todoName ?></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <?php echo $todo->id ?>
                                                ...
                                                <td><?php echo $todo->ended_date ?></td>
                                                <td><?php echo $todo->userName ?></td>
                                                <td>
                                                    <a href="/todo/todoTask/edit/<?php echo $todo->id ?>" data-toggle="tooltip" data-original-title="Засварлах"> 
                                                        <i class="fa fa-pencil text-inverse m-r-10"></i> 
                                                    </a> 
                                                    <a href="/todo/todoTask/remove/<?php echo $todo->id ?>" data-toggle="tooltip" data-original-title="Устгах"> 
