                        ...
                        <div class="card">
                            <div class="card-body">
                               <div style="float: right; " class="btn waves-effect waves-light btn-rounded btn-primary " >
                                    <a href="/course/course/add" style="color: white">Хичээлийн хуудас нэмэх</a>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $course->DName ?></td>
                                                <td><?php echo $course->CTName ?></td>
                                                <td><?php echo $course->description ?></td>
                                                 <!-- <td><?php echo $lesson->CTName ?></td>-->
                                                
                                                 <td><a href="/course/edit/<?php echo $course->Cid ?>" class=" label label-warning  font-weight-100">засах</a></td>
                                               <!-- <td><a href="/lesson/remove/<?php echo $lesson->id ?>" class="label label-danger font-weight-100">устгах</a></td>-->
                                                 <td><input class="label label-danger" type="button" onClick="remove(<?php echo $course->Cid ?>)" name="Delete" value="устгах"></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
                ...
                <script language="javascript">
                  function remove(id){
                    if (confirm("Үүнийг устгах гэж байна!")) {
                        window.location.href='/course/remove/'+id;
                        return true;
                    }
                  }
                </script>
