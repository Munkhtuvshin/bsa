        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Хичээл болон улирал нэмэх</span>
                                <form class="floating-labels m-t-40" method="POST">
                                    ...
                                    <div class="form-group m-b-40">
                                        ...
                                        <label>Орох улирал:</label>
                                    </div>
                                    <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                        <button type="submit" class="btn btn-primary font-18"><i class="mdi mdi-arrow-up"></i> Хадгалах</button>
                                        <a href="/courseSeason/getAllCourseSeason" class="btn btn-secondary font-18"><i class="mdi mdi-arrow-left"></i> Болих</a>
                                    </div>
                                </form>
                            </div>
                        </div>
