        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title"> Өрөө засах</span>
                                <form class="floating-labels m-t-40" method="POST">
                                    <div class="form-group m-b-40">
                                        <input type="text" name="name" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                       
                                        <label for="input1">Өрөөний дугаар</label>
                                    </div>
                                     <div class="form-group m-b-40">
                                        <input type="text" name="floor" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                       
                                        <label for="input1">Давхар</label>
                                    </div>
                                     <div class="form-group m-b-40">
                                        <input type="text" name="capacity" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                       
                                        <label for="input1">Хүүхдийн тоо</label>
                                    </div>
                                    <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="school_id" id="input6">
                                        ...
                                        <label>Сургуулийн хаяг:</label>
                                    </div>
                                    <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                        <button type="submit" class="btn btn-primary font-18"><i class="mdi mdi-arrow-up"></i> Хадгалах</button>
                                        <a href="/classRoom/getAllClassRoom" class="btn btn-secondary font-18"><i class="mdi mdi-arrow-left"></i> Болих</a>
                                    </div>
                                </form>
                            </div>
                        </div>
