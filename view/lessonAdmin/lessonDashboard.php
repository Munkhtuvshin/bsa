                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <!-- Row -->
                                <div class="row">
                                    <div class="col-8"><h2>3 <i class="ti-angle-down font-14 text-danger"></i></h2>
                                        <h6>Нийт файлын тоо</h6></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <!-- Row -->
                                <div class="row">
                                    <div class="col-8"><h2 class="">1 <i class="ti-angle-up font-14 text-success"></i></h2>
                                        <h6>Файл оруулсан багшийн тоо</h6></div>
                                    <div class="col-4 align-self-center text-right p-l-0">
