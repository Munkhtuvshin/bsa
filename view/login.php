                ...
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="index.html">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Имэйл эсвэл утас"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">

                                <input class="form-control" type="password" required="" placeholder="Нууц үг"> </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 font-14">
                                ...
                                </div> <a href="javascript:void(0)" id="to-recover" class="text-dark pull-right"><!-- <i class="fa fa-lock m-r-5"></i> --> Нууц үгээ мартсан?</a> </div>
                        </div>
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <div>Та бүртгэлгүй юу? <a href="reg.php" class="text-info m-l-5"><b>Бүртгүүлэх</b></a></div>
                            </div>
                        </div>
                    </form>
