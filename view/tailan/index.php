<?php
require_once ROOT . '/controller/tailanController.php';
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card card-inverse card-info">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h3 class="card-title">Нийт хичээл</h3>
                                        <?php
                                            foreach ($tailans as $tailan){
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-6 align-self-center">
                                        <h2 class="font-light text-white"><sup><small><i class="ti-arrow-up"></i></small></sup><?php echo $tailan->id ?></h2>
                                    </div>
                        ...
                        <div class="card card-inverse card-success">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h3 class="card-title">Одоо орж байгаа хичээл</h3>
