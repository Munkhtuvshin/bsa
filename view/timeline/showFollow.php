...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-book-open-variant"></i><span
                                    class="hide-menu">Sample Pages <span class="label label-rouded label-success pull-right">25</span></span></a>
                            <ul aria-expanded="false" class="collapse">
        ...
        <div class="page-wrapper">
            <!-- Show follow-ийн толгой хэсэг  -->


            <!--  Эх хэсэг дагагчидаа харах -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-9" >
                                    ...
                                    <address>
                                        ...
                                        <br/>
                                        <br/>
                                        <div style="display:flex"><abbr title="Phone">P:</abbr> (123) 456-7890
                                        <button style="height:30px; background-color:#ccc; border-radius:10px; margin-left:20px; float: right;" >Follow</button></div>                                       
                                    </address>                                    
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="../../assets/images/users/2.jpg" alt="user-img"
                                            class="img-circle"> <span>Genelia Deshmukh
