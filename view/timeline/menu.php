            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Диплом</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/diploma/view">Үзлэг</a></li>
                                <li><a href="/diploma/teachers">Багш </a></li>
                                <li><a href="/diploma/students">Оюутан</a></li>
