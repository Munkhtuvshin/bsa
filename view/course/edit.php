        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Хичээлийн удирдлагын хэсэг</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Эхлэл</a></li>
                        <li class="breadcrumb-item">Хичээлийн удирдлага</li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Хичээлийн мэдээлэл засах</h4>
                                <h6 class="card-subtitle">Хичээлийн мэдээлэл засах маягт</h6>
                                <form class="form-material m-t-40" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="<?php echo $course->name; ?>" class="form-control form-control-line"/> 
                                        <span class="text-danger"><?php echo form_error("name"); ?></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Хичээлийн код</label>
                                        <input type="text" class="form-control form-control-line" name="code" value="<?php echo $course->code; ?>" />
                                         <span class="text-danger"><?php echo form_error("code"); ?></span>
                                         </div>
                                    <div class="form-group">
                                        <label for="example-email">Кредит</label>
                                        <input type="number" name="credit" class="form-control" value="<?php echo $course->credit; ?>" />
                                         <span class="text-danger"><?php echo form_error("credit"); ?></span>
                                    </div>
                                    <div class="form-group">
                                    <label>Салбар</label>
                                    <select name="division_id" class="form-control" required="" value="<?php echo $course->division_id; ?>">
                                        <option value="1">МТ-ийн салбар</option>
                                        <option value="2">КУ-ны салбар</option>
                                        <option value="2">Холбооны салбар</option>
                                        <?php 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="course_type_id" class="form-control" required="" value="<?php echo $course->course_type_id; ?>">
                                            <option value="1">Заавал</option>
                                            <option value="2">Заавал сонгон</option>
                                            <option value="3">Сонгон</option>
                                            <option value="4">Бусад</option>
                                        <?php 
                                         //$query = "select * from course_type";
                    $query = "select  course_type.name course_type from course inner join course_type on course_type.id = course.course_type_id" ;
                                    ...
                                    <span class="text-danger"><?php echo form_error("course_type_id"); ?></span>
                                </div>
                                    <div class="form-group">
                                        <label>Хичээлийн товч тодорхойлолт</label>
                                        <input type="text" class="form-control" name="description" value="<?php echo $course->description; ?>"/>
                                         <span class="text-danger"><?php echo form_error("description"); ?></span>
                                    </div>
                                    <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                        <button type="hidden" name="hidden_id" value="<?php echo $row->id; ?>"/>
                                        <a href="/course/edit"><button type="submit" class="btn btn-primary font-18"><i class="mdi mdi-arrow-up"></i>Засах</button></a>
                                        <a href="/course" class="btn btn-secondary font-18"><i class="mdi mdi-arrow-left"></i> Болих</a>
                                    </div>
                                    <?php
                                    } 
                                    ?>
