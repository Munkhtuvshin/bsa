            ...
            <div class="container-fluid">
                ...
                <table border="1">
                     ...
                     <tr>
                         ...
                         <td><?php echo $choose->division_id; ?> </td>
                         <td><?php echo $choose->course_type_id; ?> </td>
                         <td><?php echo $choose->description; ?> </td>
                        
                <td><form action="/credit/TeacherLessonChoose/remove/<?php echo $choose->id; ?>" method="POST"><input type="submit" value="Remove"></form></td>
                     </tr>
                         <?php } ?>
            </table>
            <a href="/credit/TeacherLessonChoose/add1"><button type="button"  class="button button2" >Хичээл сонгох</button></a>                     
                <!-- Modal Add Category -->
