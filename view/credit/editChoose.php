...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <div>
            Хичээлийн нэр: <input name="name" value="<?php echo $name; ?>">
        </div>
        <div>
          Хичээлийн код: <input name="code" value="<?php echo $code; ?>">
        </div>
        <div>
        Коедит: <input name="credit" value="<?php echo $credit; ?>">
        </div>
        <div>
        school_id: <input name="division_id" value="<?php echo $division_id; ?>">
        </div>
        <div>
        parent_id: <input name="course_type_id" value="<?php echo $course_type_id; ?>">
        </div>
        <div>
        Тайлбар: <input name="description" value="<?php echo $description; ?>">
        </div>
        <div>
            <input type="submit" value="Edit">
            <a href="/credit/TeacherLessonChoose">Cancel</a>
        </div>
    </form>
