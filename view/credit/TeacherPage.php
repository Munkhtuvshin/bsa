        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Багшийн хичээл сонголтын хуудас</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <a href="/credit/TeacherPage/add2">add</a>
    <table border="1">
        <?php foreach($data as $choose){ ?>
            <tr>
                <td><?php echo $choose->instructor_user_id; ?></td>
                <td><?php echo $choose->code; ?> </td>
                <td><?php echo $choose->name; ?> </td>
                <td><?php echo $choose->credit; ?> </td>
                <td><?php echo $choose->year; ?> </td>
                <td><?php echo $choose->season_id; ?> </td>
                <td><?php echo $choose->class_room_id; ?> </td>
                <td><?php echo $choose->par; ?> </td>
