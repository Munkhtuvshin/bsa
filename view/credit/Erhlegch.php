        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"> <h3>Эрхлэгчийн хуудас</h3></h3>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            2
                            <br>
             Багш нарын тооцоо<br>
          
        <?php foreach($data as $choose){ ?>
            <div class="row">
         <div class="col-sm-12 space"><b>Багшийн ID:</b> <?php echo $choose->id; ?>     <a href="http://localhost:8000/credit/Negtgel"><?php echo $choose->name; ?> </a> <br>
         <a href="http://localhost:8000/credit/Negtgel">Буцаах</a>   
