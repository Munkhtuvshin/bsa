                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="">
                                <div class="row">
                                <div class="col-md-12 font">Багшийн жилийн ажлын кредитийн тооцоо</div>
                                    <div class="col-md-6">Багшийн овог нэр: <?php echo $choose->last_name; ?><?php echo $choose->first_name; ?></div>
                                    <div class="col-md-6">Сургуулийн нэр: <?php echo $choose->SC; ?></div>
                                    <div class="col-md-6">Багшийн код: <?php echo $choose->code; ?></div>
                                    <div class="col-md-6">Салбаын нэр:    <?php foreach($data as $choose){ ?>
                   <?php echo $choose->SA; ?>  <?php } ?> </div>
                                    <div class="col-md-12">Албан тушаал:   <?php foreach($data1 as $choose){ ?><?php echo $choose->name; ?>  <?php } ?></div>
                                    <div class="col-md-6">Ачаалал/кр/:сургалтын ажлын - 16,  Б цаг - 2,  В цаг - 2,  Бүгд - 20кр</div>
                                    <div class="col-md-6">2017/2018 оны хичээлийн жмл</div>
                                        <div class="card-body">
                                       
                                        <table name='tablename' id='table_id' Align="center">
                                            <tr>
                                                <th rowspan = "2">Д/д</th>
                                                <th rowspan = "2">ажлын нэр</th>
                                                <th colspan = "3">Норм/кредитээр/</th>
                                                <th colspan = "3">Гүйцэтгэл/кредитээр/</th>
                                                <th rowspan = "2">Нийт Гүйцэтгэл кр</th>
                                                <th rowspan = "2">Илүү цагийн кр</th>
                                                <th rowspan = "2">Гарт олгох кр</th>
                                            ...
                                            <tr>
                                                <th>1</th>
                                                <th>Сургалтын ажил /А цаг/</th>
                                                <th> <?php foreach($data2 as $Season){ ?>
                                                                     <?php echo $Season->namar; ?>
                                                                     <?php } ?></th>
                                                <th> <?php foreach($data2 as $Season){ ?>
                                                                     <?php echo $Season->havar; ?>
                                                                     <?php } ?></th>
                                                <th> <?php echo $Season->havar+ $Season->namar; ?></th>
                                                <th>ss</th>
                                                <th></th>
                                                <th></th>
                                                <th>23</th>
                                            ...
                                            <tr>
                                                <th>2</th>
                                                <th>Эрдэм шинжилгээ, инновацийн ажил /Б цаг/</th>
                                                <th><?php echo $Season->e;?></th>
                                                <th><?php echo $Season->e;?></th>
                                                <th><?php echo $Season->es;?></th>
                                                <th><?php echo $Season->i;?></th>
                                                <th></th>
                                                <th></th>
                                                <th>23</th>
                                                <th>24</th>
                                            ...
                                            <tr>
                                                <th>3</th>
                                                <th>Сургууль, олон нийтийн ажил /В цаг/</th>
                                                <th><?php echo $Season->e;?></th>
                                                <th><?php echo $Season->e;?></th>
                                                <th><?php echo $Season->es;?></th>
                                                <th><?php echo $Season->n;?></th>
                                                <th></th>
                                                <th></th>
                                                <th>23</th>
                                                <th>24</th>
                                            ...
                                            <tr>
                                                <th></th>
                                                <th>Нийт дүн</th>
                                                <th><?php echo $Season->havar+$Season->e+$Season->e;  ?></th>
                                                <th><?php echo $Season->havar+$Season->e+$Season->e;  ?></th>
                                                <th><?php echo $Season->havar+$Season->namar+$Season->es+$Season->es;  ?></th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                                <th>23</th>
                                        ...
                                        <a href="http://localhost:8000/credit/Erhlegch">илгээх</a>   
                                    </div>
                                </div>
                                <div class="row">
  <div class="col-sm-4"></div>
  <div class="col-sm-8">Тооцоо хийсэн салбарын эрхлэгч:<input type="text" class="Negtgel-input-border" size="10" placeholder="........................................................."></div>

</div>
<div class="row">
  <div class="col-sm-4"></div>
  <div class="col-sm-8">Зөвшөөрсөн багш:<input type="text" class="Negtgel-input-border" size="30" placeholder="...................................................................................."></div>

</div>
<div class="row">
  <div class="col-sm-4"></div>
  <div class="col-sm-8">Хянасан дэд захирал:<input type="text" class="Negtgel-input-border" size="10" placeholder=".........................................................">З.БуянХишиг</div>

</div>
<div class="row">
  <div class="col-sm-4"></div>
  <div class="col-sm-8">ЭНБ Дарга:<input type="text" class="Negtgel-input-border" size="20" placeholder="............................................................................................">Ж.Жавзансүрэн</div>
