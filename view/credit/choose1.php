...
<body class="fix-header card-no-border">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Хичээл сонголт</h3>
                </div>
    ...
    <table border="1">
        <?php foreach($data as $choose){ ?>
            <tr>
                <td><?php echo $choose->id; ?></td>
                <td><?php echo $choose->lesson_date; ?> </td>
                <td><?php echo $choose->code; ?> </td>
                <td><?php echo $choose->student_count; ?> </td>
                <td><?php echo $choose->subject; ?> </td>
                <td><?php echo $choose->class_type_id; ?> </td>
                <td><?php echo $choose->name; ?> </td>
                <td><?php echo $choose->Duration; ?> </td>
                <td><a href="/credit/choose/edit/<?php echo $choose->id; ?>"><?php echo $choose->name; ?></a></td>
                <td><form action="/credit/choose/remove/<?php echo $choose->id; ?>" method="POST"><input type="submit" value="Remove"></form></td>
            </tr>
        <?php } ?>
    </table>
    <a href="http://localhost:8000/credit/Calcu">Тооцоолох</a>   
     <a href="/credit/choose/add">Нэмэх Засах</a>
