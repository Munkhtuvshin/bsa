    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- ============================================================== -->
                <form method="POST" action="/credit/TeacherLessonChoose/add1">
          <div>
            id: <input name="id">
        </div>
        <div>
        ...
        <div>
            Салбарын id: <input name="division_id">
        </div>
        <div>
            Хичээлийн төрлийн  id: <input name="course_type_id">
        </div>
        <div>
            Тайлбар: <input name="description">
        </div>
        <div>
