...
<body class="fix-header card-no-border">
    ...
    <form method="POST" action="/credit/TeacherPage/add2">
          <div>
            Багшийн ID: <input name="instructor_user_id">
        </div>
        <div>
           Хичээлийн код : <input name="code">
        </div>
        <div>
            Хичээлийн нэр : <input name="name">
        </div>
        <div>
           Кредит: <input name="credit">
        </div>
        <div>
            Хичээлийн жил: <input name="year">
        </div>
        <div>
            Улирал: <input name="season_id">
        </div>
        <div>
            Ангийн ID: <input name="class_room_id">
        </div>
        <div>
            Пар: <input name="par">
        </div>
        <div>
            Хичээлийн Төрөл: <input name="class_type_id">
        </div>
        <div>
            <input type="submit" value="Add">
            <a href="/credit/TeacherPageAdd">Cancel</a>
        </div>
    </form>
