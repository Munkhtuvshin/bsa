                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See
                                                        you
                                                        at
                                                    </span> <span class="time">9:10 AM</span>
                                                </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="../../assets/images/big/img1.jpg"
                                                            alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="../../assets/images/big/img2.jpg"
                                                            alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="../../assets/images/big/img3.jpg"
                                                            alt="Third slide"></div>
                                                </div>
                                            </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Бүлэгүүд</h3>
                </div>
                            ...
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col-md-4 col-lg-3 text-center">
                                        <a href="/group/group/discussion/<?php echo 1 ?>/<?php echo $s->id ?>">
                                        <img src="<?php echo $s->params->cover ?>" alt="user" class="img-circle img-responsive"></a>
                                    </div>
                                    <div class="col-md-8 col-lg-9">
                                        <h3 class="box-title m-b-0"><?php echo $s->name; ?></h3> <small>10 шинэ нийтлэл</small>
                                        <br />
                                        <br />
                                        <a href="/group/group/discussion/<?php echo $s->table_id.'/'.$s->table_pk?>">
                                        <button type="button" class="btn waves-effect waves-light btn-rounded btn-info">Цааш үзэх</button>
                                        </a>
                                    </div>
                                </div>
                                </a> 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-xlg-4">
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-md-4 col-lg-3 text-center">
                                    <a href=""><img src="<?php echo $p->params->cover ?>" alt="user" class="img-circle img-responsive"></a>
                                </div>
                                <div class="col-md-8 col-lg-9">
                                    <h3 class="box-title m-b-0"><?php echo $p->name; ?></h3> <small>10 шинэ нийтлэл</small>
                                    <address>
                                        <?php echo $p->start_date; ?>
                                        <br />
                                        <br />
                                        <a href="/group/group/discussion/<?php echo $p->table_id.'/'.$p->table_pk?>">                                                                                
                                            <button type="button" class="btn waves-effect waves-light btn-rounded btn-info">Цааш үзэх</button>
                                        </a>
                                    </address>
                                </div>
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="../../assets/images/users/6.jpg" alt="user-img"
                                            class="img-circle"> <span>John Abraham
                                            <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="../../assets/images/users/7.jpg" alt="user-img"
                                            class="img-circle"> <span>Hritik Roshan
                                            <small class="text-success">online</small></span></a>
                                </li>
                                <li>
