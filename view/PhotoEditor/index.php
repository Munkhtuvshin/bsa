...
<head>
    ...
    <link href="/assets/css/tui-color-picker.css" rel="stylesheet">
    <link href="/assets/css/service-basic.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="tui-image-editor-controls" >
                <ul class="menu">
                    <li class="menu-item input-wrapper" style="font-weight: bold;">
                        Ачааллах
                        <input type="file" accept="image/*" id="input-image-file">
                    </li>
                    <li class="menu-item" id="btn-download" style="font-weight: bold;">Хадгалах</li>
                    <li class="menu-item disabled" id="btn-undo">Буцах</li>
                    <li class="menu-item disabled" id="btn-redo">Сэргээх</li>
                    <li class="menu-item" id="btn-clear-objects">Объектыг цэвэрлэх</li>
                    <li class="menu-item" id="btn-remove-active-object">Идэвхитэй объект устгах </li>
                    <li class="menu-item" id="btn-crop">Тайрах</li>
                    <li class="menu-item" id="btn-flip">Флип</li>
                    <li class="menu-item" id="btn-rotation">Эргүүлэх</li>
                    <li class="menu-item" id="btn-draw-shape">Хэлбэр дүрс</li>
                    <li class="menu-item" id="btn-add-icon">Таних тэмдэг</li>
                    <li class="menu-item" id="btn-text">Тэкст</li>
                    <li class="menu-item" id="btn-mask-filter">Maск</li>
                    <li class="menu-item" id="btn-image-filter">Шүүлтүүр</li>
                </ul>
                <div class="sub-menu-container" id="crop-sub-menu">
                    <ul class="menu">
                        <li class="menu-item" id="btn-apply-crop">Батлах</li>
                        <li class="menu-item" id="btn-cancel-crop">Цуцлах</li>
                    </ul>
                </div>
                <div class="sub-menu-container" id="flip-sub-menu">
                    <ul class="menu">
                        <li class="menu-item" id="btn-flip-x">ФлипX</li>
                        <li class="menu-item" id="btn-flip-y">ФлипY</li>
                        <li class="menu-item" id="btn-reset-flip">Дахин оролдох</li>
                        <li class="menu-item close">Хаах</li>
                    </ul>
                </div>
                <div class="sub-menu-container" id="rotation-sub-menu">
                    <ul class="menu">
                        <li class="menu-item" id="btn-rotate-clockwise">цагийн зүүний дагуу(30)</li>
                        <li class="menu-item" id="btn-rotate-counter-clockwise">Цагийн зүүний эсрэг(-30)</li>
                ...
                <div class="sub-menu-container" id="draw-shape-sub-menu">
                    <ul class="menu">
                        <li class="menu-item">
                            <label><input type="radio" name="select-shape-type" value="rect" checked="checked">тэгш өнцөгт</label>
                            <label><input type="radio" name="select-shape-type" value="circle"> Тойрог</label>
                            <label><input type="radio" name="select-shape-type" value="triangle"> Гурвалжин</label>
                        </li>
                        <li class="menu-item">
                            <select name="select-color-type">
                                <option value="fill">Бөглөх</option>
                                <option value="stroke">зураас</option>
                            </select>
                            <label><input type="checkbox" id="input-check-transparent">тунгалаг</label>
                            <div id="tui-shape-color-picker"></div>
                        </li>
                        <li class="menu-item"><label class="menu-item no-pointer">зураасны өргөн<input id="input-stroke-width-range" type="range" min="0" max="300" value="12"></label></li>
                        <li class="menu-item close">Хаах</li>
                    </ul>
                </div>
                <div class="sub-menu-container" id="icon-sub-menu">
                    <ul class="menu">
                        <li class="menu-item">
                            <div id="tui-icon-color-picker">Таних тэмдэгийн өнгө </div>
                        </li>
                ...
                <div class="sub-menu-container" id="text-sub-menu">
                    <ul class="menu">
                        <li class="menu-item">
                            <div>
                                <button class="btn-text-style" data-style-type="b">Тод</button>
                                <button class="btn-text-style" data-style-type="i">Налуу</button>
                                <button class="btn-text-style" data-style-type="u">Доогуур зураас</button>
                            </div>
                            <div>
                                <button class="btn-text-style" data-style-type="l">Зүүн</button>
                                <button class="btn-text-style" data-style-type="c">Төв</button>
                                <button class="btn-text-style" data-style-type="r">Баруун</button>
                            </div>
                        </li>
                        <li class="menu-item"><label class="no-pointer"><input id="input-font-size-range" type="range" min="10" max="100" value="10"></label></li>
                        <li class="menu-item">
                            <div id="tui-text-color-picker">Tестийн өнгө</div>
                        </li>
                        <li class="menu-item close">Хаах</li>
                    </ul>
                </div>
                <div class="sub-menu-container" id="filter-sub-menu">
                    <ul class="menu">
                        <li class="menu-item border input-wrapper">
                            Давхар зураг ачааллах
                            <input type="file" accept="image/*" id="input-mask-image-file">
                        </li>
                        <li class="menu-item" id="btn-apply-mask">Батлах</li>
                        <li class="menu-item close">Хаах</li>
                    </ul>
                </div>
                    ...
                    <ul class="menu">
                        <li class="menu-item align-left-top">
                            <table>
                                <tbody>
                                    <tr>
                                        <td><label><input type="checkbox" id="input-check-grayscale">Саарал</label></td>
                                        <td><label><input type="checkbox" id="input-check-invert">Урвуу</label></td>
                                        <td><label><input type="checkbox" id="input-check-sepia">Будаг</label></td>
                                    </tr>
                                    <tr>
                                        <td><label><input type="checkbox" id="input-check-sepia2">Будаг2</label></td>
                                        <td><label><input type="checkbox" id="input-check-blur">Бүдгэрүүлэх</label></td>
                                        <td><label><input type="checkbox" id="input-check-sharpen">Хурцатгах</label></td>
                                    </tr>
                                    <tr>
                        ...
                        <li class="menu-item align-left-top">
                            <p>
                                <label><input type="checkbox" id="input-check-remove-white">Арилгах</label><br>
                                <label>Босго<input class="range-narrow" id="input-range-remove-white-threshold" type="range" min="0" value="60" max="255"></label><br>
                                <label>Хоорондын зай<input class="range-narrow" id="input-range-remove-white-distance" type="range" min="0" value="10" max="255"></label>
                            </p>
                        </li>
                        <li class="menu-item align-left-top">
                            <p>
                                <label><input type="checkbox" id="input-check-brightness">цайруулалт</label><br>
                                <label>Утга<input class="range-narrow" id="input-range-brightness-value" type="range" min="-255" value="100" max="255"></label>
                            </p>
                        </li>
                        <li class="menu-item align-left-top">
                            <p>
                                <label><input type="checkbox" id="input-check-noise">Noise</label><br>
                                <label>Утга<input class="range-narrow" id="input-range-noise-value" type="range" min="0" value="100" max="1000"></label>
                            </p>
                        </li>
                        <li class="menu-item align-left-top">
                            <p>
                                <label><input type="checkbox" id="input-check-gradient-transparancy">зургийн хар цагаан</label><br>
                                <label>Утга<input class="range-narrow" id="input-range-gradient-transparency-value" type="range" min="0" value="100" max="255"></label>
                            </p>
                        </li>
                        <li class="menu-item align-left-top">
                            <p>
                                <label><input type="checkbox" id="input-check-pixelate">Пиксель</label><br>
                                <label>Утга<input class="range-narrow" id="input-range-pixelate-value" type="range" min="2" value="4" max="20"></label>
                            </p>
                        </li>
                        <li class="menu-item align-left-top">
                            <p>
                                <label><input type="checkbox" id="input-check-tint">Өнгө оруулах</label><br>
                                <div id="tui-tint-color-picker"></div>
                                <label>Опакти<input class="range-narrow" id="input-range-tint-opacity-value" type="range" min="0" value="1" max="1" step="0.1"></label>
                            </p>
                        </li>
                        <li class="menu-item align-left-top">
                            <p>
                                <label><input type="checkbox" id="input-check-multiply">Давхар өнгө</label>
                                <div id="tui-multiply-color-picker"></div>
                            </p>
                        </li>
                        <li class="menu-item align-left-top">
                            <p>
                                <label><input type="checkbox" id="input-check-blend">Өнгө сонгох</label>
                                <div id="tui-blend-color-picker"></div>
                                <select name="select-blend-type">
                                    <option value="add" selected>Нэмэх</option>
                                    <option value="diff">Diff</option>
                                    <option value="diff">Subtract</option>
                                    <option value="multiply">Multiply</option>
                                    <option value="screen">Screen</option>
                                    <option value="lighten">Lighten</option>
                                    <option value="darken">Харанхуйлах</option>
                                </select>
                            </p>
    ...
    <script src="/assets/js/fabric.js"></script>
        <script src="/assets/js/tui-code-snippet.min.js"></script>
    
        <script src="/assets/js/FileSaver.min.js"></script>
        <script  src="/assets/js/colorpicker.min.js"></script>
        <script src="/assets/js/tui-image-editor.js"></script>
        <script src="/assets/js/service-basic.js"></script>
</body>
