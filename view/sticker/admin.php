        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <a class="text-themecolor" href="index.php" >Back</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="store.php">Home</a></li>
                        <li class="breadcrumb-item">Sticker</li>
                        <li class="breadcrumb-item active">Sticker Store</li>
                    </ol>
                </div>
                <div class="">
            ...
            <!-- ============================================================== -->
            <div class="row page-titles" style="background:url(../../assets/images/background/storeimg.jpg) no-repeat center top">
                <div class="col-lg-12 text-center">
                    <h1 class="m-t-30">Sticker Store</h1>
                    <h5 class="text-muted m-b-30"><i class="ti-pin"></i>Find new stickers to send to friends</h5>
                </div>
            </div>
            <!-- ============================================================== -->
            <!-- Container fluid  -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Стикерийн жагсаалт</span>
                                <a href="#newStickerModal">
                                    <button class="pull-right btn btn-sm btn-rounded btn-info" img src="../assets/images/alert/model.png" alt="default" data-toggle="modal" data-target="#newStickerModal" class="model_img img-responsive" />
                                        <i class="fa fa-plus"></i>
                                        <span>Стикер нэмэх</span>
                                    </button>
                                </a>
                            </div>
                        </div>
                        <div id="newStickerModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <img style="width: 100%;" src="../../assets/images/big/t1.jpg">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-danger waves-effect waves-light save-category"   data-dismiss="modal">Save changes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 col-lg-3 text-center">
                                        <a href="img-detail.html"><img src="../../assets/images/users/<?php echo $stickerAlbum->image_url; ?>" alt="user" class="img-circle img-responsive"></a>
                                    </div>
                                    <div class="col-md-8 col-lg-9">
                                        <h3 class="box-title m-b-0"><?php echo $stickerAlbum->name; ?></h3> <small>Admin</small>
                                        <div class="button-group">
                                            <button type="button" class="btn waves-effect waves-light btn-secondary" href="#editStickerModal<?php echo $i; ?>" data-toggle="modal" data-target="#editStickerModal<?php echo $i; ?>">edit</button>
                                            </button>
                                            <!--<button type="button" class="btn waves-effect waves-light btn-success">free</button>-->
                                            <button type="button" class="btn waves-effect waves-light btn-danger" href="#deleteModal<?php echo $i; ?>" data-toggle="modal" data-target="#deleteModal<?php echo $i; ?>">delete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="editStickerModal<?php echo $i; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">EDit new Sticker</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                </div>
                                <div class="modal-body">
                                    <div class="col-md-6">
                                        <label class="control-label">Sticker Name</label>
                                        <input class="form-control form-white" placeholder="Enter name" type="text" name="category-name" value="haha" />
                                    </div>
                                    <div class="row">
                                        <?php foreach($stickerAlbum->stickers as $stickers) { ?>
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <img style="width: 100%;" src="../../assets/images/big/<?php echo $stickers->image_url ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <input class="form-control" type="text" name="name" value="<?php echo $stickers->name ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <button onclick="openFileSelect()" class="btn btn-primary">Нэмэх</button>
                                                    <input id="newImage" name="stickerImg" type="file" style="display:none;">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                    ...
                    <div id="deleteModal<?php echo $i; ?>" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-sm">
                            ...
                            <div class="modal-footer">
                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                    <a href="/sticker/admin/deleteStickerAlbum/<?php echo $stickerAlbum->id; ?>" class="btn btn-danger waves-effect waves-light">Delete</a>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
