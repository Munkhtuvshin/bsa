                        ...
                        <div class="card card-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    ...
                                    <button type="button" class="btn waves-effect waves-light btn-secondary"> <a href="/sticker/sticker/getStickersByAlbum/<?php echo $stickerAlbum->id; ?>" >preview</button>
                                    <!--<button type="button" class="btn waves-effect waves-light btn-success">free</button>-->
                                    <a class="btn btn-success" href="/sticker/sticker/toggleStickerToUser/<?php echo $stickerAlbum->id; ?>">
                                        <i class="text<?php if($stickerAlbum->down_user_id == 1) {echo '-active';} ?>" aria-hidden="true"></i>
                                        <span class="text<?php if($stickerAlbum->down_user_id == 1) {echo '-active';} ?>">free</span>
                                        <i class="text<?php if($stickerAlbum->down_user_id == null) {echo '-active';} ?>" aria-hidden="true"></i>
                                        <span class="text<?php if($stickerAlbum->down_user_id == null) {echo '-active';} ?>">remove</span>
                                    </a>
                                </div>
                                </div>
                            </div>
