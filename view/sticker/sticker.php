        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <a class="text-themecolor" href="/sticker/sticker/" >Sticker Store</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/sticker/sticker/">Home</a></li>
                        <li class="breadcrumb-item">Sticker Store</li>
                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-md-4 col-lg-3 text-center">
                                    <a href="#"><img src="../../../assets/images/users/a1.jpg" alt="user" class="img-circle img-responsive"></a>
                                </div>
                                <div class="col-md-8 col-lg-9">
                                    <h3 class="box-title m-b-0"><?php echo $stickerAlbumName->name; ?></h3> <small>Admin</small>
                                    <div class="button-group">
                                    <!--<button type="button" class="btn waves-effect waves-light btn-success">free</button>-->
                                    <a class="btn btn-success" href="/sticker/sticker/toggleStickerToUser/<?php echo $stickerAlbumName->id; ?>">
                                        <i class="text<?php if($hasSticker) echo '-active'; ?>" aria-hidden="true"></i>
                                        <span class="text<?php if($hasSticker) echo '-active'; ?>">free</span>
                                        <i class="text<?php if(!$hasSticker) echo '-active'; ?>" aria-hidden="true"></i>
                                        <span class="text<?php if(!$hasSticker) echo '-active'; ?>">remove</span>
                                    </a>
                                    <div class="row">
                                        <?php foreach($stickers as $sticker){ ?>
                                        <div class="col-md-6"> <img src="../../../assets/images/big/<?php echo $sticker->image_url; ?>" class="img-responsive thumbnail m-r-15"> </div>
                                        <?php } ?>
                                    </div>
                                </div>
                                </div>
