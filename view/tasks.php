            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Хийх зүйлийн жагсаалт</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" style="background-color:transparent" id="todoTask" class="btn">Хийх ажлууд </button><span class="btn btn-info btn-xs">15</span><br><br>
                                <button type="button" style="background-color:transparent" id="doneTask" class="btn">Хийсэн ажлууд 
                                </button><span  class="btn btn-info btn-xs">12</span>
                                <br><br><br>
                                <h4>Төрөл</h4><br>
                                <!-- sample modal content -->
                                <div id="responsive-modal-addType" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Төрөл нэмэх</h4>
                                            ...
                                            <form action="createCategory.php" method="POST">
                                                <div class="modal-body">
                                                    <form>
                                                        <div class="form-group">
                                                            <label for="type-name" name="cat_name" class="control-label">Төрлийн нэр:</label>
                                                            <input type="text" class="form-control" id="type-name">
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Болих</button>
                                                    <button type="submit" class="btn btn-danger waves-effect waves-light" name="add_task">Хадгалах</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    ?>
                                    <li class="list-group-item"><?php echo $category->name ?> <span  class="btn btn-danger btn-xs pull-right">12</span></li>
                                    <?php
                                    }
                                    ?>
                                   <li class="list-group-item"><a href="" id="addTask" class="action action_add_item" data-toggle="modal" data-target="#responsive-modal-addType" class="model_img img-responsive">+ Төрөл Нэмэх</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Хийх зүйлсийн жагсаалт</span>
                                <button class="pull-right btn btn-sm btn-rounded btn-info" data-toggle="modal" data-target="#responsive-modal-addTodo">
                                    <i class="fa fa-plus"></i>
                                    <span>Ажил Нэмэх</span>
                                </button>
                                <!-- sample modal content -->
                                <div id="responsive-modal-addTodo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Хийх ажил нэмэх</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <form>
                                                    <div class="form-group">
                                                        <label for="todo-name" class="control-label">Хийх ажлын нэр:</label>
                                                        <input type="text" class="form-control" id="recipient-name">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="date" class="control-label">Хугацаа:</label><br>
                                                        <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                                            <button type="button" class="btn btn-secondary font-20" data-toggle="tooltip" data-placement="bottom" title="Өнөөдөр"><i class="fa fa-calendar-o"></i></button>
                                                            <button type="button" class="btn btn-secondary font-20" data-toggle="tooltip" data-placement="bottom" title="Маргааш"><i class="fa fa-sun-o"></i></button>
                                                            <button type="button" class="btn btn-secondary font-20" data-toggle="tooltip" data-placement="bottom" title="Сарын хугацаанд"><i class="fa fa-moon-o"></i></button>
                                                            <button type="button" class="btn btn-secondary font-20" data-toggle="tooltip" data-placement="bottom" title="Өдөр сонгох"><i class="fa fa-calendar"></i></button>
                                                            <button type="button" class="btn btn-secondary font-20" data-toggle="tooltip" data-placement="bottom" title="Тодорхой хугацаагүй"><i class="fa fa-times"></i></button>
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-group fileupload btn btn-info waves-effect waves-light">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select form-control pull-right">
                                                            ...
                                                            ?>
                                                            <option value=""><?php echo $todo->todo_list_category_id ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Болих</button>
                                                <button type="button" class="btn btn-danger waves-effect waves-light">Хадгалах</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="checkbox checkbox-info ">
                                                        <input type="checkbox" id="" name="inputCheckboxesSchedule">
                                                        <label for="inputSchedule" class=""> </label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-circle" data-toggle="button" aria-pressed="false">
                                                        <i class="fa fa-star text" aria-hidden="true"></i>
                                                        <i class="fa fa-star text-active text-warning" aria-hidden="true"></i>
                                                    </button>
                                                </td>
                                                <td><?php echo $todo->name ?></td>
                                                <td><?php echo $todo->todo_list_category_id ?></td>
