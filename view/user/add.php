                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Шинэ хэрэглэгч</h4>
                                ...
                                <form class="form-material m-t-40" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="example-email">Ургийн овог</label>
