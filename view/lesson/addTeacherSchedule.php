        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Багш хөтөлбөр нэмэх хэсэг</span>
                                <form class="floating-labels m-t-40" method="POST">
                                    ...
                                    <div class="form-group m-b-40">
                                        <input type="text" name="week_day" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                       
                                        <label for="input1">Хэд дэх өдөр</label>
                                    </div>

                                    <div class="form-group m-b-40">
                                        <input type="text" name="par" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                       
                                        <label for="input1">Хэддүгээр паар</label>
                                    </div>

                                    <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="class_room_id" id="input6">
                                            <option value="0" selected="" disabled="">Сонгох</option>
                                   ...
                                   <div class="form-group m-b-40">
                                     ...
                                     <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="instructor_user_id" id="input6">
                                            <option value="0" selected="" disabled="">Сонгох</option>
                                    ...
                                    <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                        ...
                                        <a href="/teacherSchedule/getAllTeacherSchedule" class="btn btn-secondary font-18"><i class="mdi mdi-arrow-left"></i> Болих</a>
                                    </div>
                                </form>
                            </div>
                        </div>
