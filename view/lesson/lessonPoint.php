                        ...
                        <div class="card">
                            <div class="card-body">
                               <!--<div style="float: right; " class="btn waves-effect waves-light btn-rounded btn-primary " >
                                    <a href="/lessonPoint/add" style="color: white"> Оноо нэмэх</a>
                                </div>-->
                                   ...
                                   <div class="table-responsive">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>№</th>
                                                <th>Хичээлийн материалын сэдэв</th>
                                                <th>Эхлэх хугацаа</th>
                                        ...
                                        <tbody>
                                            <?php
                                                foreach ($lessonPoints as $lessonPoint){
                                            ?>
                                            <tr>
                                                <td><?php echo $lessonPoint->LPid ?></td>
                                                <td><?php echo $lessonPoint->Lsubject ?></td>
                                                <td><?php echo $lessonPoint->start_date ?></td>
                                                <td><?php echo $lessonPoint->end_date ?></td>                                                
                                               <td><?php echo $lessonPoint->point ?></td>
                                                
                                                

                                                 <td><a href="/lessonPoint/edit/<?php echo $lessonPoint->LPid ?>" class=" label label-warning  font-weight-100">засах</a></td>
                                               <!-- <td><a href="/lesson/remove/<?php echo $lesson->id ?>" class="label label-danger font-weight-100">устгах</a></td>-->
                                                 <td><input class="label label-danger" type="button" onClick="remove(<?php echo $lessonPoint->LPid ?>)" name="Delete" value="Delete"></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
                ...
                <script language="javascript">
                  function remove(id){
                    if (confirm("Үүнийг устгах гэж байна!")) {
                        window.location.href='/lessonPoint/remove/'+id;
                        return true;
                    }
                  }
                </script>
