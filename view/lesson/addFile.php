        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Файл нэмэх</span>
                                <form class="floating-labels m-t-40" method="POST">
                                    <div class="form-group m-b-40">
                                     ...
                                     <div class="form-group m-b-40">
                                        <input type="file" name="path" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                       
                                        
                                    </div>
                                    <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="user_id" id="input6">
                                    ...
                                    <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="owner_type_id" id="input6">
                                            <option value="0" selected="" disabled="">Сонгох</option>
                                                ...
                                                ?>
                                                <?php 
                                              echo '<option value="' . $ownerType->id . '">' . $ownerType->name . '</option>';
                                                ?>
                                                <?php
                                                }
                                                ?>
                                     ...
                                     <div class="form-group m-b-40">
                                        <input type="text" name="owner_id" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                       
                                        <label for="input1">Эзэмшигчийн код</label>
                                    </div>
                                    <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                        <button type="submit" class="btn btn-primary font-18"><i class="mdi mdi-arrow-up"></i> Хадгалах</button>
                                        <a href="/file/getAllFile" class="btn btn-secondary font-18"><i class="mdi mdi-arrow-left"></i> Болих</a>
                                    </div>
                                </form>
                            </div>
                        </div>
