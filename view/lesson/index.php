                        ...
                        <div class="card">
                            <div class="card-body">
                               <div style="float: right; " class="btn waves-effect waves-light btn-rounded btn-primary " >
                                    <a href="/lesson/add" style="color: white"> Даалгавар нэмэх</a>
                                </div>
                                   ...
                                   <div class="table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $lesson->Lid ?></td>
                                                <td><?php echo $lesson->CYear ?></td>
                                                <td><?php echo $lesson->subject ?></td>                                                
                                               <td><?php echo $lesson->CTName ?></td>
                                                <td><?php echo $lesson->description ?></td>
                                                <td><a href="/lessonPoint/getAllLessonPoint/<?php echo $lesson->Lid ?>" class=" label label-success  font-weight-100">дэлгэрэнгүй</a></td>

                                                 <td><a href="/lesson/edit/<?php echo $lesson->Lid ?>" class=" label label-warning  font-weight-100">засах</a></td>
                                               <!-- <td><a href="/lesson/remove/<?php echo $lesson->id ?>" class="label label-danger font-weight-100">устгах</a></td>-->
                                                 <td><input class="label label-danger" type="button" onClick="remove(<?php echo $lesson->Lid ?>)" name="Delete" value="Delete"></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
