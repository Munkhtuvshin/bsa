                        ...
                        <div class="card">
                            <div class="card-body">
                               <div style="float: right; " class="btn waves-effect waves-light btn-rounded btn-primary " >
                                    <a href="/teacherSchedule/add" style="color: white"> Хөтөлбөр нэмэх</a>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <!-- <td><?php echo $lesson->CTName ?></td>-->
                                                 ...
                                                 <td><a href="/teacherSchedule/edit/<?php echo $teacher_schedule->TSid ?>" class=" label label-warning  font-weight-100">засах</a></td>
                                               <!-- <td><a href="/lesson/remove/<?php echo $lesson->id ?>" class="label label-danger font-weight-100">устгах</a></td>-->
                                                 <td><input class="label label-danger" type="button" onClick="remove(<?php echo $teacher_schedule->TSid ?>)" name="Delete" value="Delete"></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
                ...
                <script language="javascript">
                  function remove(id){
                    if (confirm("Үүнийг устгах гэж байна!")) {
                        window.location.href='/teacherSchedule/remove/'+id;
                        return true;
                    }
                  }
                </script>
