            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                 <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Багш хичээлийн материал дээр оноо нэмэх хэсэг</span>
                                <form class="floating-labels m-t-40" method="POST">

                                    <div class="form-group m-b-40">
                                        <input type="datetime-local" name="start_date" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group m-b-40">
                                        <input type="datetime-local" name="end_date" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group m-b-40">
                                        <input type="text" name="point" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                       
                                        <label for="input1">Оноо</label>
                                    </div>

                                     <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="lesson_id" id="input6">
                                        ...
                                        <a href="/lessonPoint/getAllLessonPoint" class="btn btn-secondary font-18"><i class="mdi mdi-arrow-left"></i> Болих</a>
                                    </div>
                                </form>
                            </div>
                        </div>
