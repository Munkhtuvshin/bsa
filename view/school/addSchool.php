        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                <span class="card-title">Сургууль нэмэх</span>
                                <form class="floating-labels m-t-40" method="POST">
                                    <div class="form-group m-b-40">
                                        <input type="text" name="schoolName" class="form-control" id="input1" required>
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="parent" id="input6"">
                                            ...
                                            <?php foreach ($schools as $school){ ?>
                                                <?php echo '<option value="' . $school->parent_id . '">' . $school->name . '</option>'; ?>
                                            <?php } ?>
                                      ...
                                      <div class="form-group m-b-40">
                                        <select class="form-control p-0" name="address_id" id="input6"">
                                            ...
                                            <?php foreach ($addresss as $address){ ?>
                                                <?php echo '<option value="' . $address->id . '">' . $address->name . '</option>'; ?>
                                            <?php } ?>
                                        </select><span class="bar"></span>
