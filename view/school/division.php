                        ...
                        <div class="card">
                            <div class="card-body">
                               <div style="float: right; " class="btn waves-effect waves-light btn-rounded btn-primary " >
                                    <a href="/school/division/add/<?php echo $school->id ?>" style="color: white">Салбар нэмэх</a>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $division->parent_id ?></td>
                                                <td>
                                                    <a href="/school/division/edit/<?php echo $division->id ?>" class="btn btn-sm btn-primary"><i class="mdi mdi-pencil"></i></a>
                                                    <a class="btn btn-sm btn-danger" href="javascript:remove(<?php echo $division->id ?>)"><i class="mdi mdi-delete"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
                ...
                <script language="javascript">
                  function remove(id){
                    if (confirm("Үүнийг устгах гэж байна!")) {
                        window.location.href='/school/division/remove/'+id;
                        return true;
                    }
                  }
                </script>
