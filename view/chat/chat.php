                            ...
                            <div class="chat-main-box">
                                ...
                                <div class="chat-right-aside">
                                        ...
                                        <ul class="chat-list p-20">
                                            <?php 
                                                foreach ($chatrooms as $key => $chatroom) {
                                                    ...
                                                    echo '<li><div class="chat-content"><h5>'.$from.'</h5><div class"box bg-light-info">'.$chatroom['msg'].'</div></div><div class="chat-time">'.date("d/m/Y h:i:s A", strtotime($chatroom['created_on'])).'</div></li>';
                                                }
                                            ?>
                                        </ul>
                                    </div>
                                    <div class="card-body b-t">
                                        <div class="row">
                                            <div class="col-8">
                                                <textarea placeholder="Type your message here" class="form-control b-0" id="msg" name="msg"></textarea>
                                            </div>
                                            <div class="col-4 text-right">
                                                <button type="button" class="btn btn-info btn-circle btn-lg" id="send" name="send"><i class="fa fa-paper-plane-o"></i> </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
