                ...
                <div class="col-lg-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <span>
                                <h4 class="m-b-0 text-white">Оюутны мэдээлэл засах</h4> 
                            </span>
                            <span>
                        ...
                        <?php foreach ($result as $key => $value) { ?>
                            <form action="/adviser/student/edit/<?php echo $result->id ?>" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="middle_name" class="form-control" value="<?php echo $value->middle_name ?>">
                                        </div>
                                    </div>
                                     <div class="form-group row">
