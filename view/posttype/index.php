        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Нийтлэлийн төрөл</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Эхлэл</a></li>
                        <li class="breadcrumb-item">Тохиргоо</li>
                        <li class="breadcrumb-item active">Нийтлэлийн төрөл</li>
                    </ol>
                </div>
                <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                    <a href="/posttype/add" class="btn btn-secondary font-18"><i class="mdi mdi-plus"></i></a>
                                </div>
                                <h4 class="card-title">Нийтлэлийн төрөл</h4>
                                <h6 class="card-subtitle">Хэрэглэгчийн үүсгэж болох нийтлэлийн төрлүүд</h6>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Нийтлэлийн төрөл</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $postType->id ?></td>
                                                <td><a href="/posttype/edit/<?php echo $postType->id ?>"><?php echo $postType->name ?></a></td>
                                                <td><a class="btn btn-xs btn-danger" href="/posttype/remove/<?php echo $postType->id ?>"><i class="fa fa-times"><i></a></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
