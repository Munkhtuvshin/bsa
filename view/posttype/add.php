                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Нийтлэлийн шинэ төрөл нэмэх</h4>
                                <h6 class="card-subtitle">Нийтлэлийн шинэ төрөл нэмэх бүртгэх маягт</h6>
                                <form class="form-material m-t-40" method="POST">
                                    ...
                                    <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                        ...
                                        <a href="/posttype" class="btn btn-secondary font-18"><i class="mdi mdi-arrow-left"></i> Болих</a>
                                    </div>
                                </form>
                            </div>
                        </div>
