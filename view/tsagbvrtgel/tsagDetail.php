        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">БАГШИЙН АЖЛЫН КРЕДИТ ТООЦОХ ХУУДАС</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Эхлэл</a></li>
                        <li class="breadcrumb-item">Хэрэглэгчийн удирдлага</li>
                        <li class="breadcrumb-item active">БАГШИЙН АЖЛЫН КРЕДИТ ТООЦОХ ХУУДАС</li>
                    </ol>
                </div>
                <div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Сургуулийн нэр: Мэдээлэл, Холбооны Технологийн Сургууль</h4>
                                <h5 class="card-title">Салбарын нэр: Мэдээллийн Технологийн салбар</h5>
                                <h6 class="card-subtitle">Албан тушаал: Багш</h6>
                                <h6 class="card-subtitle">Багшийн код, овог нэр: D.IS10 Төмөрболдын Золбоо</h6>
                                <h6 class="card-subtitle">Эрдмийн зэрэг, цол: Магистр</h6>
                                <h6 class="card-subtitle">Хичээлийн код, нэр: <?php echo  $code.' '.$name; ?></h6>
                                <h6 class="card-title">2017-2018 оны хичээлийн жил Намрын улирал</h6>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $num ?></td>
                                                <td><?php echo $tsag->date ?></td>
                                                <td><?php echo $tsag->code ?></td>
                                                <td><?php echo $tsag->std_count ?></td>
                                                <td><?php echo $tsag->subject ?></td>
                                                <td><?php echo $tsag->type ?></td>
                                                <td><?php echo "0" ?></td>
                                            </tr>
                                            <?php
                                            $num++;
