        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">БАГШИЙН СУРГАЛТЫН АЖЛЫН  КРЕДИТИЙН ТООЦОО</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Эхлэл</a></li>
                        <li class="breadcrumb-item">Хэрэглэгчийн удирдлага</li>
                        <li class="breadcrumb-item active">БАГШИЙН СУРГАЛТЫН АЖЛЫН  КРЕДИТИЙН ТООЦОО</li>
                    </ol>
                </div>
                <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="btn-group m-b-10 m-r-10" role="group" aria-label="Button group with nested dropdown">
                                    <a href="/user/add" class="btn btn-secondary font-18"><i class="mdi mdi-plus"></i></a>
                                ...
                                <h4 class="card-title">Хичээлийн жагсаалт</h4>
                                <h6 class="card-subtitle">Таны ордог бүх хичээлийн жагсаалт</h6>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            $num = 1;
                                            foreach ($teacherTsag as $tsag){
                                            ?>
                                            <tr>
                                                <td><?php echo $num; ?></td>
                                                <td><?php echo $tsag->code; ?></td>
                                                <td><?php echo $tsag->name; ?></td>
                                                <td><?php echo $tsag->class_type_name; ?></td>
                                                <td><?php echo $tsag->credit; ?></td>
                                                <td><?php if($tsag->code[4] == "3") echo "1.2"; else if($tsag->code[4] == "2") echo "1"; else if($tsag->code[4] == "2") echo "1";?></td>
                                                <td><?php echo $tsag->id; ?></td>
                                                <td><form method="POST" action="/tsagBvrtgel/tsagDetail"><input type="hidden" name="name" value="<?php echo $tsag->name; ?>"></input><input type="hidden" name="code" value="<?php echo $tsag->code; ?>"></input><input type="hidden" name="id" value="<?php echo $tsag->idd; ?>"></input><button class="btn btn-info" type="submit">Дэлгэрэнгүй</button></form></td>
                                            </tr>
                                            <?php
                                            $num++;
                                            }
