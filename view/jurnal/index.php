                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Таны орох хичээл</h6>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $jurnal->subject ?></td>
                                                <td><?php echo $jurnal->week_day ?></td>
                                                <td><?php echo $jurnal->class_id ?></td>
                                                <td><?php echo $jurnal->par ?></td>
                                                <td><?php echo $jurnal->lesson_date ?></td>
                                                <td>@Genelia</td>
                                                <td><span class="label label-danger">админ</span> </td>
                                                <td><form method="POST" action="jurnal/jurnalDetail"><input name="id" value="<?php echo $jurnal->id ?>" type="hidden"></input><Button class="btn btn-success" type="submit">Дүн оруулах</Button></form></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
