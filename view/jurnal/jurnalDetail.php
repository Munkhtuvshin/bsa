            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Хичээл</h4>
                                <h6 class="card-subtitle">Шинэ хэрэглэгч бүртгэх маягт</h6>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>№</th>
                                    ...
                                    <tbody>
                                        ...
                                        $dvn;
                                        $name;
                                        foreach ($jurnal as $jurnalDvn){
                                            
                                        ?>
                                            <tr>
                                                <td><?php echo $i ?></td>
                                                <td><?php echo $jurnalDvn->id ?></td>
                                                <td><?php echo $jurnalDvn->last_name ?></td>
                                                <td><?php echo $jurnalDvn->first_name ?></td>
                                                <td><?php echo $jurnalDvn->point ?></td>
                                                <td><a class="btn btn-primary" data-toggle="modal" href="#<?php $idd = $jurnalDvn->id; $dvn = $jurnalDvn->point; $name = $jurnalDvn->first_name; ?>" data-target="#exampleModal" style="color: white;">Засах</a></td>
                                            </tr>
                                        <?php
                                        $i++;
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Дүн оруулах</h5>
                ...
                <input name="id" value="<?php echo $id ?>" type="hidden"></input>
                    <table class="table">
                        <tbody>
                            <tr>
                                <th>Оюутны код</th>
                                <td><input name="studentId" value="<?php echo $idd; ?>" readonly></td>
                            </tr>
                            <tr>
                                <th>Оюутны нэр</th>
                                <td><input value="<?php echo $name; ?>"readonly></td>
                            <tr>
                            </tr>
                                <th>Дүн</th>
                                <td><input name="dvn" type="number" value="<?php echo $dvn; ?>"></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Болих</button>
