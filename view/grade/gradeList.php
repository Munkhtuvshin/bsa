            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Student_Lesson Table</h4>
                                
                                <div class="table-responsive">
                                    <table class="table color-table primary-table">
                                        <a href="/grade/grade/add"><button>add</button></a>
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Point</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $grade->student_user_id;?> </td>
                                                <td><?php echo $grade->lesson_id;?> </td>
                                                <td><a href="/grade/grade/edit/<?php echo $grade->id;?>"> zasah</a></td>
                                                <td>
                                                    <form action="/grade/grade/remove/<?php echo $grade->id; ?>" method="POST"><input type="submit" value="Remove"></form>
                                                </td>
                                            </tr>
                                        <?php }?>
                                        </tbody>
