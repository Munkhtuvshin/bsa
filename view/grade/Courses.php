                ...
                <div class="row">
                    <div class="col-12 m-t-40">
                        ...
                        <?php foreach($courses as $course){
                            $items = Array("danger", "primary", "info", "warning", "default");
                            $className = $items[array_rand($items)];
                            ?>
                            
                                <div class="col-lg-4 col-md-6 col-xlg-2 col-xs-12" >
                                    <div class="ribbon-wrapper card" style="min-height: 120px !important;">
                                        <a href="/grade/grade/grade/<?php echo $course->id;?>" style="display:flex;">
                                        <div class="ribbon ribbon-<?php echo $className; ?> ribbon-right"><?php echo $course->name; ?></div>
                                        <p class="ribbon-content"><?php echo $course->description; ?> </p>
                                        </a>
                                    </div>
                                </div>
                        <?php }?>
